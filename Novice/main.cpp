...
const char kWindowTitle[] = "GC2B_04_ゴ_タクウ";
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		Matrix4x4 resultSubstract = Subtract(m1, m2);
		...
		MatrixScreenPrintf(0, kRowHeight * 5, resultSubstract, "Substract");
		...
		MatrixScreenPrintf(kColumnWidth * 5, kRowHeight * 5, transposeM1, "transposeM2");
