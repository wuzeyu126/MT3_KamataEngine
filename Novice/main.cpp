...
//			Vector3 c = Add(sphere.center, Vector3(sphere.radius * cosf(lat + kLatEvery) * cosf(lon + kLonEvery), sphere.radius * sinf(lat + kLatEvery), sphere.radius * cosf(lat + kLatEvery) * sinf(lon + kLonEvery)));
//			// a,b,cをScreen座標系まで変換
